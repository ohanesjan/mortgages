...
df_loan_fixed_test=loan_analysis(amount=400000, first_date=np.datetime64('2020-02-01'), loan_period =12 ,fixed_period=12,
                  fixed_interest=2.38, var_base_interest=0, var_interest=0)

print(df_loan_fixed_test)
print(df_loan_fixed_test[''])
...
plt.plot(df_loan_fixed['payment'][0:12],label='2.38%')
...
#%%
total_fixed=df_loan_fixed['payment'][np.datetime64('2020-02-01'):np.datetime64('2023-06-01')].sum()
